...
const _$d=document.querySelectorAll,_$n=NodeList.prototype,$=t=>_$d(t),$_wrap=t=>"string"==typeof t?$(t):t,$ea=(t,e)=>([].concat($_wrap(t)).filter(t=>t).forEach(e),t),$eon=(t,e,r)=>([].concat($_wrap(t)).filter(t=>t&&t.addEventListener).forEach(t=>t.addEventListener(e,r)),t),$addClass=(t,e)=>([].concat($_wrap(t)).filter(t=>t&&t.classList).forEach(t=>t.classList.add(e)),t),$removeClass=(t,e)=>([].concat($_wrap(t)).filter(t=>t&&t.classList).forEach(t=>t.classList.remove(e)),t),$toggleClass=(t,e)=>([].concat($_wrap(t)).filter(t=>t&&t.classList).forEach(t=>t.classList.toggle(e)),t),$css=(t,e)=>([].concat($_wrap(t)).filter(t=>t&&t.style).forEach(t=>Object.assign(t.style,e)),t),$attr=(t,e,r)=>{let o=$_wrap(t);return void 0===r?o[0]?.getAttribute(e):([].concat(o).filter(t=>t&&t.setAttribute).forEach(t=>t.setAttribute(e,r)),t)},$html=(t,e)=>void 0===e?$_wrap(t)[0]?.innerHTML:([].concat($_wrap(t)).filter(t=>t).forEach(t=>t.innerHTML=e),t),$text=(t,e)=>void 0===e?$_wrap(t)[0]?.textContent:([].concat($_wrap(t)).filter(t=>t).forEach(t=>t.textContent=e),t),$get=t=>fetch(t).then(t=>t.text()),$getJSON=t=>fetch(t).then(t=>t.json()),$1st=t=>$(t)[0]||null,$1ast=t=>$(t)[$(t).length-1]||null,$len=t=>$_wrap(t).length;_$n.$ea=function(t){return $ea(this,t)},_$n.$eon=function(t,e){return $eon(this,t,e)},_$n.$addClass=function(t){return $addClass(this,t)},_$n.$removeClass=function(t){return $removeClass(this,t)},_$n.$toggleClass=function(t){return $toggleClass(this,t)},_$n.$css=function(t){return $css(this,t)},_$n.$attr=function(t,e){return $attr(this,t,e)},_$n.$html=function(t){return $html(this,t)},_$n.$text=function(t){return $text(this,t)},_$n.$len=function(){return $len(this)};
